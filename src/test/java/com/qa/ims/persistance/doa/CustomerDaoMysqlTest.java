...
//	}
	...
	public void bCreateTest() {
		CustomerDaoMysql customerDaoMysql = new CustomerDaoMysql("jdbc:mysql://localhost:3306/ims?serverTimezone=UTC",
				"root", "root");
		Long id = 1L;
		String forename = "Vinesh";
		String surname = "Ghela";
		String username = "Vdog";
		String password = "password123";
		String email = "vg@gmail.com";
		Customer customer = new Customer("Vinesh", "Ghela", "Vdog", "password123", "vf@gmail.com");
		String firstName2 = "James";
		String surname2 = "Peach";
		Customer customer2 = new Customer(2L, firstName2, surname);
